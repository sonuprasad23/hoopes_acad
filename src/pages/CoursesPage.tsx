    ...
    subjects: {
      ...
      physics: {
        ...
        units: [{
          ...
          id: 13,
          title: 'Magnetic Effects and Magnetism'
        }, {
          id: 14,
      ...
      chemistry: {
        ...
        units: [{
          ...
          id: 16,
          title: 'Organic Compounds with Halogens'
        }, {
          id: 17,
          title: 'Organic Compounds with Oxygen'
        }, {
          id: 18,
          title: 'Organic Compounds with Nitrogen'
        }, {
          id: 19,
          title: 'Biomolecules'
        }]
...
const CoursesPage: React.FC = () => {
  ...
  return <div className="w-full">
      {!courseId && <div className="bg-gradient-to-r from-orange-500 to-orange-600 text-white p-6 rounded-lg shadow-lg mb-6">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 mb-6">
        ...
        <p className="mt-2 text-gray-600 dark:text-gray-300">
          {course ? course.description : 'Explore our comprehensive courses designed to help you excel in your exams.'}
        </p>
      </div>
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
        {course ? <div className="space-y-8">
            {Object.entries(course.subjects).map(([key, subject]) => <div key={key} className="border-b border-gray-200 dark:border-gray-700 pb-8 last:border-0">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {subject.units.map(unit => <div key={unit.id} className="p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:border-orange-500 transition-colors">
            ...
            {Object.entries(courseData).map(([key, course]) => <div key={key} className="border border-gray-200 dark:border-gray-700 rounded-lg p-6 hover:border-orange-500 transition-colors">
                ...
                <div className="space-y-2">
                  {Object.values(course.subjects).map(subject => <div key={subject.name} className="flex items-center text-gray-600 dark:text-gray-400">
